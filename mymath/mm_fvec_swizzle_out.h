...
namespace mymath
{
  namespace impl
  {
    ...
    {
      return vec3i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, a, 0 ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle < b, a, a, -3 >::operator vec3i<float>() const
    {
      return vec3i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( b, a, a, 0 ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle < a, b, a, -3 >::operator vec3i<float>() const
    {
      return vec3i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, b, a, 0 ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle < a, a, b, -3 >::operator vec3i<float>() const
    {
      return vec3i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, b, 0 ) ) );
    }
    ...
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, a, a ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle<b, a, a, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( b, a, a, a ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle<a, b, a, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, b, a, a ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle<a, a, b, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, b, a ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle<a, a, a, b>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, a, b ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle<a, b, a, b>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, b, a, b ) ) );
    }

    template<int a, int b>
    vec2i<float>::swizzle<a, a, b, b>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, b, b ) ) );
    }
    ...
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( bt, a, a, a ) ) );
    }

    template<int a, int bt>
    vec3i<float>::swizzle<a, bt, a, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, bt, a, a ) ) );
    }

    template<int a, int bt>
    vec3i<float>::swizzle<a, a, bt, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, bt, a ) ) );
    }

    template<int a, int bt>
    vec3i<float>::swizzle<a, a, a, bt>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( a, a, a, bt ) ) );
    }

    template<int a, int bt, int c>
    vec3i<float>::swizzle<bt, c, a, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( bt, c, a, a ) ) );
    }

    template<int a, int bt, int c>
    vec3i<float>::swizzle<bt, a, c, a>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( bt, a, c, a ) ) );
    }

    template<int a, int bt, int c>
    vec3i<float>::swizzle<bt, a, a, c>::operator vec4i<float>() const
    {
      return vec4i<float>( _mm_shuffle_ps( v, v, MM_SHUFFLE( bt, a, a, c ) ) );
    }
  }
}
